...
/**
 * Remove the unique index on the clientid field from the lti_types table.
 *
 * @return bool true
 */
function ltisource_switch_config_remove_client_id_unique_index() {
  global $DB;
 ...
 * Install function.
 */
function xmldb_ltisource_switch_config_install() {
